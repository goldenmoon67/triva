  ...
  Widget build(BuildContext context) {
    return GestureDetector(
        ...
        child: OverlaySupport.global(
          //overlay supports for creating overlays, making it easier to build toasts and in-app notifications across all platforms.
          child: MaterialApp.router(
            localizationsDelegates: const [],
            onGenerateTitle: (BuildContext context) => "Default Flutter",
