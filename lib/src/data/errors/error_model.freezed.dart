...
abstract class $ErrorModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? code, String? statusCode, String? message, String? error});
}
...
class _$ErrorModelImpl implements _ErrorModel {
  const _$ErrorModelImpl(
      {this.code, this.statusCode, this.message, this.error});
  ...
  @override
  String toString() {
    return 'ErrorModel(code: $code, statusCode: $statusCode, message: $message, error: $error)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, code, statusCode, message, error);
...
abstract class _ErrorModel implements ErrorModel {
  const factory _ErrorModel(
      ...
      final String? statusCode,
      final String? message,
      final String? error}) = _$ErrorModelImpl;
